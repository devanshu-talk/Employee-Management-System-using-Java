...
public class Print_Data implements ActionListener{
	...
	JFrame f;
    JLabel id8,id,aid,id1,aid1,id2,aid2,id3,aid3,id4,aid4,id5,aid5,id6,aid6,id7,
    		aid7,id9,id10,id11,id12,id13,id14,id15,id16,id17,lab;
    ...
    Print_Data(String e_id){
        ...
        id9.setLayout(null);
        ImageIcon img=new ImageIcon(ClassLoader.getSystemResource("com/devtalk/icons/print.jpg"));
        id9.setIcon(img);
